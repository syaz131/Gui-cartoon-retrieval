...
"")
        ...
        self.doubleSpinBox_4.setGeometry(QtCore.QRect(170, 70, 71, 22))
        ...
        self.doubleSpinBox_4.setProperty("value", 0.004)
        self.doubleSpinBox_4.setObjectName("doubleSpinBox_4")
        self.doubleSpinBox_5 = QtWidgets.QDoubleSpinBox(self.groupBox_4)
        self.doubleSpinBox_5.setGeometry(QtCore.QRect(170, 100, 71, 22))
        ...
        self.doubleSpinBox_6.setGeometry(QtCore.QRect(170, 40, 71, 22))
...
"background-color: none;")
        ...
        self.spinBox_4.setGeometry(QtCore.QRect(170, 70, 71, 22))
        self.spinBox_4.setMinimum(1)
        self.spinBox_4.setMaximum(2000)
        self.spinBox_4.setProperty("value", 336)
        self.spinBox_4.setObjectName("spinBox_4")
        self.spinBox_5 = QtWidgets.QSpinBox(self.groupBox_3)
        self.spinBox_5.setGeometry(QtCore.QRect(170, 40, 71, 22))
        self.spinBox_5.setMinimum(1)
        self.spinBox_5.setMaximum(2000)
        self.spinBox_5.setProperty("value", 600)
        ...
        self.spinBox_6.setGeometry(QtCore.QRect(170, 100, 71, 22))
        self.spinBox_6.setMinimum(1)
        self.spinBox_6.setMaximum(2000)
...
"background-color: none;")
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(490, 10, 661, 511))
        self.groupBox_5.setStyleSheet("background-color:white;")
        self.groupBox_5.setObjectName("groupBox_5")
        self.btn_chooseFolder = QtWidgets.QPushButton(self.groupBox_5)
        self.btn_chooseFolder.setEnabled(True)
        self.btn_chooseFolder.setGeometry(QtCore.QRect(470, 430, 131, 51))
        self.btn_chooseFolder.setStyleSheet("font: 9pt \"Arial Rounded MT Bold\", \"Arial\";\n"
"background-color: none;")
        self.btn_chooseFolder.setObjectName("btn_chooseFolder")
        self.label_dirAdvance = QtWidgets.QLabel(self.groupBox_5)
        self.label_dirAdvance.setGeometry(QtCore.QRect(60, 430, 411, 51))
        self.label_dirAdvance.setStyleSheet("border: 1px solid gray;\n"
"padding-left: 10px;")
        self.label_dirAdvance.setObjectName("label_dirAdvance")
...
"background-color: none;")
        ...
        self.radioButton_videoFolder.setGeometry(QtCore.QRect(60, 380, 161, 20))
...
"padding-left: 10px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_chooseFolder.setText(_translate("MainWindow", "Choose Folder"))
        self.label_dirAdvance.setText(_translate("MainWindow", "Folder Directory"))
